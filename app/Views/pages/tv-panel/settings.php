    ...
    <section class="card tv-settings-card">
        ...
        <div class="tv-settings-grid tv-settings-grid-texts">
            ...
            <div class="tv-field-wide tv-tip-banner-field" data-tip-banner-uploader>
                ...
                <?php if (!empty($tvConfig['dailyTipBanner'])): ?><label class="tv-remove-banner"><input type="checkbox" name="remove_daily_tip_banner" value="1"> Remover banner atual</label><?php endif; ?>
            </div>
...
<script src="<?= base_url('assets/js/pages/tv-panel-settings.js?v=3') ?>"></script>
