...
class AppServiceProvider
{
    public static function register(Container $container): void
    {
        ...
        */
        ...
        $container->singleton(SchoolYearRepository::class);
        $container->singleton(SchoolPeriodRepository::class);
        $container->singleton(SchoolDayRepository::class);
        $container->singleton(AcademicLifecycleRepository::class);
